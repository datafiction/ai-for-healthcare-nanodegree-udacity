...
class SlicesDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Identify 3D volume using ID, which is the first index of the slc variable
        vol_name = self.data[slc[0]]
        
        # Construct image and label data
        img = vol_name["image"][slc[1]]
        seg = vol_name["seg"][slc[1]][None, :]
        
        # Construct new keys and transform Numpy arrays to PyTorch tensors on GPU
        # ATTRIBUTION: Construction based on hints given on Udacity Knowledge Forum:
        #      https://knowledge.udacity.com/questions/244031
